...
class BaseSMA(Root):
    ...
    def train(self):
        ...
        sol=solution()
        if self.verbose:
            print("HHO is now tackling  \""+self.obj_func.__name__+"\"")    
        ...
        sol.convergence=self.loss_train
        sol.optimizer="BaseSMA"   
        sol.objfname=self.obj_func.__name__
        sol.best = g_best[self.ID_FIT]
        sol.bestIndividual = g_best[self.ID_POS]
        return sol
